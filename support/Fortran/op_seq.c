...
int OP_diags           = 0;
int OP_part_size       = 0;
int OP_block_size      = 512;
int OP_cache_line_size = 128;
...
void 
op_decl_map_f (op_set * from, op_set * to, int dim, int ** map, op_map * mapping, char * name )
{
  mapping->from = *from;
  mapping->to   = *to;
  mapping->dim  = dim;
...
void 
op_decl_map (op_set from, op_set to, int dim, int * map, op_map * mapping, char * name )
{
  mapping->from = from;
  mapping->to   = to;
  mapping->dim  = dim;
...
void 
op_decl_dat_f (op_set * set, int dim, char * type, int size, void **dat, op_dat *data, char * name)
{
  data->set   = *set;
  data->dim   = dim;
  data->type = type;
  ...
  cudaMemcpy((void *) data->dat_d, (void *) data->dat, data->size*set->size, cudaMemcpyHostToDevice);
  cudaThreadSynchronize();	
}

void 
op_decl_dat_scalar (op_set * set, int dim, char * type, int size, int dat, op_dat *data, char * name)
{
  data->set = NULL;
  data->dim = dim;
  data->type = type;
...
void 
op_decl_dat (op_set set, int dim, char * type, int size, void *dat, op_dat *data, char * name)
{
  data->set   = set;
  data->dim   = dim;
  data->type = type;
...
void 
op_decl_const_f ( int dim, void **dat, char const *name )
{
  if ( dim <= 0 )
	{
		 ...
		 char ** p_arg)
{
  ...
  // global variable, no mapping at all
  if (mapIn->dim == -1)
  {
    n2 = 0;
  }
...
void 
op_par_loop_2 (void (*subroutineName)(char *, char *), op_set * set,
...
void 
op_par_loop_3 (void (*subroutineName)(char *, char *), op_set * set,
									  op_dat * dat0, int itemSel0, op_map * map0, op_access access0,
									  op_dat * dat1, int itemSel1, op_map * map1, op_access access1,
									  op_dat * dat2, int itemSel2, op_map * map2, op_access access2)
{
	...
	for (i = 0; i < set->size; i++) 
	{
		...
		(*subroutineName) (ptr0, ptr1, ptr2);
	}
}

void 
op_par_loop_4 (void (*subroutineName)(char *, char *, char *, char *, char *), op_set * set,
									  op_dat * dat0, int itemSel0, op_map * map0, op_access access0,
									  op_dat * dat1, int itemSel1, op_map * map1, op_access access1,
									  op_dat * dat2, int itemSel2, op_map * map2, op_access access2,
									  op_dat * dat3, int itemSel3, op_map * map3, op_access access3)
{
	...
	{	
		...
		(*subroutineName) (ptr0, ptr1, ptr2, ptr3);
	}	
}

void 
op_par_loop_5 (void (*subroutineName)(char *, char *, char *, char *, char *), op_set * set,
									  op_dat * dat0, int itemSel0, op_map * map0, op_access access0,
									  op_dat * dat1, int itemSel1, op_map * map1, op_access access1,
									  op_dat * dat2, int itemSel2, op_map * map2, op_access access2,
									  op_dat * dat3, int itemSel3, op_map * map3, op_access access3,
...
void 
op_par_loop_6 (void (*subroutineName)(char *, char *, char *, char *, char *, char *), op_set * set,
									  op_dat * dat0, int itemSel0, op_map * map0, op_access access0,
									  op_dat * dat1, int itemSel1, op_map * map1, op_access access1,
									  op_dat * dat2, int itemSel2, op_map * map2, op_access access2,
									  op_dat * dat3, int itemSel3, op_map * map3, op_access access3,
...
void 
op_par_loop_7 (void (*subroutineName)(char *, char *, char *, char *, char *, char *, char *, char *), op_set * set,
										op_dat * dat0, int itemSel0, op_map * map0, op_access access0,
										op_dat * dat1, int itemSel1, op_map * map1, op_access access1,
										op_dat * dat2, int itemSel2, op_map * map2, op_access access2,
										op_dat * dat3, int itemSel3, op_map * map3, op_access access3,
										...
										op_dat * dat6, int itemSel6, op_map * map6, op_access access6)
{
	...
	for (i = 0; i < set->size; i++) 
	{
		...
		(*subroutineName) (ptr0, ptr1, ptr2, ptr3, ptr4, ptr5, ptr6);
	}	
}

void 
op_par_loop_8 (void (*subroutineName)(char *, char *, char *, char *, char *, char *, char *, char *), op_set * set,
										op_dat * dat0, int itemSel0, op_map * map0, op_access access0,
										op_dat * dat1, int itemSel1, op_map * map1, op_access access1,
										op_dat * dat2, int itemSel2, op_map * map2, op_access access2,
										op_dat * dat3, int itemSel3, op_map * map3, op_access access3,
...
void 
op_par_loop_12 (void (*subroutineName)(char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *, char *),
		      op_set * set,
		      op_dat * dat0, int itemSel0, op_map * map0, op_access access0,
		      op_dat * dat1, int itemSel1, op_map * map1, op_access access1,
		      op_dat * dat2, int itemSel2, op_map * map2, op_access access2,
...
//
//	wrapper from Fortran to plan function
//
op_plan * 
cplan (char name[],
	   int setId,
