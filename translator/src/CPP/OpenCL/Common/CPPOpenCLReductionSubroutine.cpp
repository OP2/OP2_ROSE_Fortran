...
SgStatement *
CPPOpenCLReductionSubroutine::createSynchThreadsCallStatement ()
{
  ...
  SgFunctionSymbol * functionSymbol =
      CPPTypesBuilder::buildNewCPPSubroutine (
          OpenCL::CPP::syncthreads, subroutineScope);
...
CPPOpenCLReductionSubroutine::createStatements ()
{
  ...
  SgSubtractOp * subtractExpression1 = buildSubtractOp (buildDotExp (
      buildOpaqueVarRefExp (OpenCL::CPP::threadidx, subroutineScope),
      buildOpaqueVarRefExp (OpenCL::CPP::x, subroutineScope)),
      buildIntVal (1));
  ...
  SgExpression * blockdimXExpr = buildDotExp (buildOpaqueVarRefExp (
      OpenCL::CPP::blockidx, subroutineScope), buildOpaqueVarRefExp (
      OpenCL::CPP::x, subroutineScope));

  SgFunctionSymbol * shiftFunctionSymbol =
      CPPTypesBuilder::buildNewCPPFunction ("ishft", subroutineScope);
   ...
   * recomputed in terms of the CPP kind type of the
   * reduction variable
   * ======================================================
   */
...
CPPOpenCLReductionSubroutine::createLocalVariableDeclarations ()
{
  ...
  SgArrayType * arrayType = CPPTypesBuilder::getArray_RankOne (
...
CPPOpenCLReductionSubroutine::createFormalParameterDeclarations ()
{
  ...
  /*
   * ======================================================
   * Declare the the warp size: currently, in OpenCL CPP
