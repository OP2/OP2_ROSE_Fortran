...
void
FortranCUDAUserDeviceSubroutine::copyAndModifySubroutine ()
{
  using boost::iequals;
...
void
FortranCUDAUserDeviceSubroutine::createStatements ()
{
...
std::string const &
FortranCUDAUserDeviceSubroutine::getHostSubroutineName ()
{
