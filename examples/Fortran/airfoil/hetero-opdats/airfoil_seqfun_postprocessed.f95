# 1 "/home/abetts/SILOET/OP2_ROSE_Fortran/examples/Fortran/airfoil/hetero-opdats/airfoil_seqfun.F95"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/abetts/SILOET/OP2_ROSE_Fortran/examples/Fortran/airfoil/hetero-opdats/airfoil_seqfun.F95"
...
subroutine res_calc ( x1, x2, fakeInt1, fakeInt2, q1, q2, adt1, adt2, res1, res2 ) BIND(C)
	...
	real(8), dimension(*) :: x1
	real(8), dimension(*) :: x2
	integer(4), dimension(3) :: fakeInt1
	integer(4), dimension(3) :: fakeInt2
	real(8), dimension(*) :: q1
	real(8), dimension(*) :: q2
