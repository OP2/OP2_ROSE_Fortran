# 1 "/home/abetts/SILOET/OP2_ROSE_Fortran/examples/Fortran/airfoil/hetero-opdats/airfoil.F95"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/abetts/SILOET/OP2_ROSE_Fortran/examples/Fortran/airfoil/hetero-opdats/airfoil.F95"
...
!	integer(4) :: debugiter
  ...
  integer(4), dimension(:), allocatable, target :: fakeInt
  ...
  character(kind=c_char,len=4) :: fakeIntName = C_CHAR_'fake'//C_NULL_CHAR
  ...
  call op_decl_dat ( cells, 3, fakeInt, p_fakeInt, fakeIntName )
  ...
  do niter = 1, iterationNumber
    ...
    do k = 1, 2
      ...
      call op_par_loop_10 ( res_calc, edges, &
                         & p_x,       1, pedge,  OP_READ, &
                         & p_x,       2, pedge,  OP_READ, &
                         & p_fakeInt, 1, pecell, OP_READ, &
                         & p_fakeInt, 2, pecell, OP_READ, &
