module res_calc_openmp
	...
	integer, allocatable, dimension(:) :: pindMaps1
	integer(4) :: pindMaps1Size

	integer, allocatable, dimension(:) :: pindMaps3
	integer(4) :: pindMaps3Size

	integer, allocatable, dimension(:) :: pindMaps5
	integer(4) :: pindMaps5Size

	integer, allocatable, dimension(:) :: pindMaps7
...
!      ind_arg3_s[d+n*4] = ZERO_float;                                             
		...
		function op_par_loop_res_calc ( subroutineName, set, &
			...
			type(op_dat) :: arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8
			...
			type(op_map) :: map1, map2, map3, map4, map5, map6, map7, map8
...
!			print *, 'In res calc par loop'
			...
			if ( isFirstTimeExecuting_res_calc .eqv. .true. ) then ! generate kernel input data
				...
				arg7Size = arg7%dim * arg7%set%size
...
!			print *, 'In res calc par loop, at the end'
			...
			! timing end
			op_par_loop_res_calc%hostTime = 0.0
			op_par_loop_res_calc%kernelTime = 0.0
