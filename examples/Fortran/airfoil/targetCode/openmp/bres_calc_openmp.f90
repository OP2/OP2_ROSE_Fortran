module bres_calc_openmp
	...
	integer, allocatable, dimension(:) :: pindMaps4
...
!      ind_arg3_s[d+n*4] = ZERO_float;                                             
		...
		function op_par_loop_bres_calc ( subroutineName, set, &
			...
			type(op_dat) :: arg1, arg2, arg3, arg4, arg5, arg6
			...
			type(op_map) :: map1, map2, map3, map4, map5, map6
	...
	!				print *, 'After converting stuff, nelems size = ', actualPlan%nblocks
			...
			! timing end
			op_par_loop_bres_calc%hostTime = 0.0
			op_par_loop_bres_calc%kernelTime = 0.0
