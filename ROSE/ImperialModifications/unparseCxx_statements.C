...
//-----------------------------------------------------------------------------------
void
Unparse_ExprStmt::unparseOneElemConInit (SgConstructorInitializer* con_init,
    SgUnparse_Info& info)
{
  ...
  if (con_init->get_need_name ()
      && unp->u_sage->printConstructorName (con_init))
  {
    curprint ("(");
    ...
    bool outputParameterDeclaration, SgUnparse_Info& info)
{
  ...
  if (storage.isRegister ())
  {
    ...
    // curprint( "register ");
    if ((funcdecl_stmt->get_oldStyleDefinition () == false)
        || (outputParameterDeclaration == true))
    {
      curprint ("register ");
    }
  }
  ...
  if (funcdecl_stmt->get_oldStyleDefinition () == true)
  {
    ...
    {
      printf (
          "Mixing old style C function parameters with C++ is not well defined, I think \n");
    }
...
void
Unparse_ExprStmt::unparseFunctionArgs (SgFunctionDeclaration* funcdecl_stmt,
    SgUnparse_Info& info)
{
  ROSE_ASSERT (funcdecl_stmt != NULL);
...
//-----------------------------------------------------------------------------------
void
Unparse_ExprStmt::unparse_helper (SgFunctionDeclaration* funcdecl_stmt,
    SgUnparse_Info& info)
{
  ROSE_ASSERT (funcdecl_stmt != NULL);
  ...
  bool isFirstDeclaration = funcdecl_stmt
      == funcdecl_stmt->get_firstNondefiningDeclaration ();
  if (funcdecl_stmt->get_declarationModifier ().isFriend () == true
      && funcdecl_stmt->get_specialFunctionModifier ().isOperator () == false
  ...
  SgName nameQualifier = unp->u_name->generateNameQualifier (funcdecl_stmt,
      ninfoForFunctionName);
#endif
...
void
Unparse_ExprStmt::unparseLanguageSpecificStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ...
  switch (stmt->variantT ())
  {
    ...
    case V_SgUpcNotifyStatement:
      unparseUpcNotifyStatement (stmt, info);
      break;
    case V_SgUpcWaitStatement:
      unparseUpcWaitStatement (stmt, info);
      break;
    case V_SgUpcBarrierStatement:
      unparseUpcBarrierStatement (stmt, info);
      break;
    case V_SgUpcFenceStatement:
      unparseUpcFenceStatement (stmt, info);
      break;
    case V_SgUpcForAllStatement:
      unparseUpcForAllStatement (stmt, info);
      break;
    ...
    {
      printf (
          "CxxCodeGeneration_locatedNode::unparseLanguageSpecificStatement: Error: No handler for %s (variant: %d)\n",
...
void
Unparse_ExprStmt::unparseNamespaceDeclarationStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
...
void
Unparse_ExprStmt::unparseNamespaceDefinitionStatement (SgStatement* stmt,
    SgUnparse_Info & info)
{
  ROSE_ASSERT (stmt != NULL);
...
void
Unparse_ExprStmt::unparseNamespaceAliasDeclarationStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
...
void
Unparse_ExprStmt::unparseUsingDirectiveStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
  SgUsingDirectiveStatement* usingDirective =
      isSgUsingDirectiveStatement (stmt);
  ...
  SgName nameQualifier = unp->u_name->generateNameQualifier (
      usingDirective->get_namespaceDeclaration (), info);
...
void
Unparse_ExprStmt::unparseUsingDeclarationStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ...
  if (declarationStatement != NULL)
  {
    ...
    switch (declarationStatement->variantT ())
    {
      ...
      case V_SgVariableDefinition:
      {
        ...
        SgVariableDefinition* variableDefinition = isSgVariableDefinition (
            declarationStatement);
      ...
      case V_SgTemplateDeclaration:
      {
        ...
        SgTemplateDeclaration* templateDeclaration = isSgTemplateDeclaration (
            declarationStatement);
      ...
      case V_SgEnumDeclaration:
      {
        SgEnumDeclaration* enumDeclaration = isSgEnumDeclaration (
            declarationStatement);
      ...
      {
        printf (
            "Default reached in unparseUsingDeclarationStatement(): case is not implemented for %s \n",
            declarationStatement->sage_class_name ());
        ROSE_ASSERT (false);
      }
    }
...
void
Unparse_ExprStmt::unparseTemplateInstantiationDirectiveStmt (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ...
  switch (declarationStatement->variantT ())
  {
    ...
    {
      printf (
          "Unparsing of SgVariableDeclaration in unparseTemplateInstantiationDirectiveStmt not implemented \n");
      ROSE_ASSERT (false);
      break;
    }
    ...
    case V_SgMemberFunctionDeclaration:
    {
      ...
      printf (
          "Error: SgMemberFunctionDeclaration case found in unparseTemplateInstantiationDirectiveStmt ... (exiting) \n");
      ROSE_ASSERT (false);
#if 0
    ...
    {
      printf (
          "Error: default reached in switch (declarationStatement = %s) \n",
...
void
Unparse_ExprStmt::unparseTemplateInstantiationDeclStmt (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ...
  {
    if (templateInstantiationDeclaration->get_file_info ()->isOutputInCodeGeneration ()
        == true)
    {
#if PRINT_DEVELOPER_WARNINGS
  ...
  {
    curprint (string (
        "/* Skipped output of template class declaration (name = ")
...
void
Unparse_ExprStmt::unparseTemplateInstantiationFunctionDeclStmt (
    SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  ROSE_ASSERT (templateInstantiationFunctionDeclaration->get_file_info ()
      != NULL);
  ...
  if (isTransformed (templateInstantiationFunctionDeclaration) == true)
  {
    ...
    bool
        skipforwardDeclarationOfTemplateSpecialization =
            (templateInstantiationFunctionDeclaration->get_file_info ()->isCompilerGenerated ()
                == true)
                && (templateInstantiationFunctionDeclaration->get_definition ()
                    == NULL)
    ...
    bool
        skipInlinedTemplates =
            templateInstantiationFunctionDeclaration->get_functionModifier ().isInline ();
  ...
  else
  {
    ...
    ROSE_ASSERT (
        templateInstantiationFunctionDeclaration->get_templateDeclaration ()
            != NULL);
    ROSE_ASSERT (
        templateInstantiationFunctionDeclaration->get_templateDeclaration ()->get_file_info ()
            != NULL);
    ROSE_ASSERT (
        templateInstantiationFunctionDeclaration->get_templateDeclaration ()->get_file_info ()->get_filename ()
            != NULL);
    string
        declarationFileName =
            templateInstantiationFunctionDeclaration->get_templateDeclaration ()->get_file_info ()->get_filename ();
    ...
    if (templateInstantiationFunctionDeclaration->get_file_info ()->isOutputInCodeGeneration ()
        == true)
    {
...
void
Unparse_ExprStmt::unparseTemplateInstantiationMemberFunctionDeclStmt (
    SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  if (isTransformed (templateInstantiationMemberFunctionDeclaration) == true)
  {
    ...
    SgDeclarationStatement
        * definingDeclaration =
            templateInstantiationMemberFunctionDeclaration->get_definingDeclaration ();
    // ROSE_ASSERT(definingDeclaration != NULL);
    SgMemberFunctionDeclaration* memberFunctionDeclaration =
        (definingDeclaration == NULL) ? NULL : isSgMemberFunctionDeclaration (
            definingDeclaration);
    // ROSE_ASSERT(memberFunctionDeclaration != NULL);
  ...
  else
  {
    ...
    ROSE_ASSERT (
        templateInstantiationMemberFunctionDeclaration->get_templateDeclaration ()
            != NULL);
    ROSE_ASSERT (
        templateInstantiationMemberFunctionDeclaration->get_templateDeclaration ()->get_file_info ()
            != NULL);
    ROSE_ASSERT (
        templateInstantiationMemberFunctionDeclaration->get_templateDeclaration ()->get_file_info ()->get_filename ()
            != NULL);
    string
        declarationFileName =
            templateInstantiationMemberFunctionDeclaration->get_templateDeclaration ()->get_file_info ()->get_filename ();
    ...
    // if ( declarationFileName == currentFileName )
    // if ( declarationFileName == currentFileName && templateInstantiationMemberFunctionDeclaration->get_file_info()->isOutputInCodeGeneration() == true)
    if (templateInstantiationMemberFunctionDeclaration->get_file_info ()->isOutputInCodeGeneration ()
        == true)
    {
      // printf ("Declaration appears in the current source file. \n");
      outputMemberFunctionTemplateInstantiation = true;
  ...
  if (outputMemberFunctionTemplateInstantiation == true)
  {
    ...
    if (templateInstantiationMemberFunctionDeclaration->isSpecialization ()
        == true)
    {
      if ((templateInstantiationMemberFunctionDeclaration->get_file_info ()->isCompilerGenerated ()
          == true)
...
void
Unparse_ExprStmt::unparsePragmaDeclStmt (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ...
  {
    curprint (string ("\n#pragma ident \"") + pragmaString.substr (
        identSubstring.size () + 1) + "\"\n");
  }
  else
  {
...
void
Unparse_ExprStmt::unparseBasicBlockStmt (SgStatement* stmt,
    SgUnparse_Info& info)
{
...
static size_t
countElsesNeededToPreventDangling (SgStatement* s)
{
...
void
Unparse_ExprStmt::unparseIfStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  while (if_stmt != NULL)
  {
    ...
    {
      size_t elsesNeededForInnerIfs = countElsesNeededToPreventDangling (
...
Unparse_ExprStmt::unparseWhereStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  if (where_stmt->get_init_stmt ().size () > 0)
  {
    ...
    if ((*i) != NULL && (*i)->variant () == EXPR_STMT)
    {
      ...
      if (pAssignOp != NULL)
      {
        SgFunctionCallExp* pFunctionCallExp = isSgFunctionCallExp (
            pAssignOp->get_rhs_operand ());
...
Unparse_ExprStmt::unparseForStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  {
    printf (
        "Warning in unparseForStmt(): for_stmt->get_for_init_stmt() == NULL \n");
    curprint (string ("; "));
  }
...
void
fixupScopeInUnparseInfo (SgUnparse_Info& ninfo,
    SgDeclarationStatement* declarationStatement)
{
  ...
  if (ninfo.forceQualifiedNames () == false)
  {
    ...
    if (currentScope == NULL)
    {
      ...
      switch (parentOfFunctionDeclaration->variantT ())
      {
        ...
        {
          printf (
              "Error: default reached in evaluation of function declaration structural location parentOfFunctionDeclaration = %s \n",
...
#define OUTPUT_FUNCTION_DECLARATION_DATA 0
    ...
    if (funcdecl_stmt->get_firstNondefiningDeclaration () != NULL)
    {
      SgFunctionDeclaration* firstNondefiningFunction =
          isSgFunctionDeclaration (
              funcdecl_stmt->get_firstNondefiningDeclaration ());
      ROSE_ASSERT (firstNondefiningFunction != NULL);
      ROSE_ASSERT (firstNondefiningFunction->get_firstNondefiningDeclaration ()
          != NULL);
#if 0
      ...
      {
        ROSE_ASSERT (TransformationSupport::getSourceFile (funcdecl_stmt)
            != NULL);
        ROSE_ASSERT (TransformationSupport::getSourceFile (
            firstNondefiningFunction) != NULL);
        if (TransformationSupport::getSourceFile (funcdecl_stmt)
            != TransformationSupport::getSourceFile (firstNondefiningFunction))
        {
          printf ("firstNondefiningFunction = %p \n", firstNondefiningFunction);
          printf (
              "funcdecl_stmt = %p funcdecl_stmt->get_scope()                                        = %p \n",
              funcdecl_stmt, funcdecl_stmt->get_scope ());
          printf (
              "funcdecl_stmt = %p funcdecl_stmt->get_declarationModifier().isFriend()               = %s \n",
              funcdecl_stmt,
              funcdecl_stmt->get_declarationModifier ().isFriend () ? "true"
                  : "false");
          printf (
              "firstNondefiningFunction = %p firstNondefiningFunction->get_declarationModifier().isFriend() = %s \n",
              firstNondefiningFunction,
              firstNondefiningFunction->get_declarationModifier ().isFriend () ? "true"
                  : "false");
          printf (
              "TransformationSupport::getSourceFile(funcdecl_stmt = %p)->getFileName()              = %s \n",
              funcdecl_stmt, TransformationSupport::getSourceFile (
                  funcdecl_stmt)->getFileName ().c_str ());
          printf (
              "TransformationSupport::getSourceFile(funcdecl_stmt->get_scope() = %p)->getFileName() = %s \n",
              funcdecl_stmt->get_scope (),
              TransformationSupport::getSourceFile (funcdecl_stmt->get_scope ())->getFileName ().c_str ());
          printf (
              "TransformationSupport::getSourceFile(firstNondefiningFunction = %p)->getFileName()   = %s \n",
              firstNondefiningFunction, TransformationSupport::getSourceFile (
                  firstNondefiningFunction)->getFileName ().c_str ());
          printf (
              "TransformationSupport::getSourceFile(firstNondefiningFunction->get_scope() = %p)->getFileName() = %s \n",
              firstNondefiningFunction->get_scope (),
              TransformationSupport::getSourceFile (
                  firstNondefiningFunction->get_scope ())->getFileName ().c_str ());
        ...
        if (TransformationSupport::getSourceFile (funcdecl_stmt->get_scope ())
            != TransformationSupport::getSourceFile (firstNondefiningFunction))
        {
          printf ("firstNondefiningFunction = %p \n", firstNondefiningFunction);
          printf (
      ...
      {
        printf (
            "Warning failing test: firstNondefiningFunction->get_symbol_from_symbol_table() != NULL, apepars to happen for tutorial/rose_inputCode_InstrumentationTranslator.C \n");
      }
...
{
  SgMemberFunctionDeclaration* mfuncdecl_stmt = isSgMemberFunctionDeclaration (
      stmt);
  ...
  if (mfuncdecl_stmt->get_CtorInitializerList () != NULL)
  {
    ...
    unparseAttachedPreprocessingInfo (
        mfuncdecl_stmt->get_CtorInitializerList (), ninfo,
        PreprocessingInfo::before);
  }
  ...
  if (isSgTemplateInstantiationMemberFunctionDecl (mfuncdecl_stmt) != NULL)
  {
    ...
    SgStatement* parentStatement =
        isSgStatement (mfuncdecl_stmt->get_parent ());
  ...
  if (!mfuncdecl_stmt->isForward () && mfuncdecl_stmt->get_definition ()
  ...
  else
  {
...
#endif
    SgClassDefinition *parent_class = isSgClassDefinition (
        mfuncdecl_stmt->get_parent ());
    ...
    if (parent_class && parent_class->get_declaration ()->get_class_type ()
        == SgClassDeclaration::e_class && !info.skipCheckAccess ())
    {
        ...
        || mfuncdecl_stmt->get_specialFunctionModifier ().isConversion ()))
    {
      ...
      {
        printf (
            "In unparseMFuncDeclStmt: (should not happen) mfuncdecl_stmt->get_type()->get_return_type() = %p = %s \n",
            mfuncdecl_stmt->get_type ()->get_return_type (),
            mfuncdecl_stmt->get_type ()->get_return_type ()->sage_class_name ());
    ...
    else
    {
      ...
      {
        printf (
            "mfuncdecl_stmt->get_orig_return_type() == NULL mfuncdecl_stmt = %p = %s = %s \n",
            mfuncdecl_stmt, mfuncdecl_stmt->class_name ().c_str (),
...
#error "DEAD CODE!"
    ...
    SgName nameQualifier = unp->u_name->generateNameQualifier (mfuncdecl_stmt,
        ninfo);
    ...
    SgMemberFunctionType *mftype = isSgMemberFunctionType (
        mfuncdecl_stmt->get_type ());
    ...
    {
      int first = 1;
      SgInitializedNamePtrList::iterator p =
          mfuncdecl_stmt->get_ctors ().begin ();
      ...
      while (p != mfuncdecl_stmt->get_ctors ().end ())
      {
        ...
        if (initializer != NULL)
        {
          ...
          bool outputParenthesis = (isSgConstructorInitializer (initializer)
              == NULL);
  ...
  if (mfuncdecl_stmt->get_CtorInitializerList () != NULL)
    unparseAttachedPreprocessingInfo (
        mfuncdecl_stmt->get_CtorInitializerList (), info,
        PreprocessingInfo::after);
}
...
Unparse_ExprStmt::unparseVarDeclStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  bool
      outputTypeDefinition =
          vardecl_stmt->get_variableDeclarationContainsBaseTypeDefiningDeclaration ();
...
#define REWRITE_MACRO_HANDLING
    ...
    if (!vardecl_stmt->isForward () && !isSgFunctionType (tmp_type))
    {
      ...
      if (tmp_init != NULL)
      {
        ...
        {
          SgStringVal *stringValueExpression = isSgStringVal (
          ...
          if (stringValueExpression != NULL)
          {
            ...
            if (location != string::npos)
            {
              ...
              string remainingString = stringValue.replace (location,
                  targetStringLength, "");
    ...
    if (p == vardecl_stmt->get_variables ().begin ())
    {
      ...
      decl_item = *p;
      ROSE_ASSERT (decl_item != NULL);
      unp->u_exprStmt->unparseAttachedPreprocessingInfo (decl_item, info,
          PreprocessingInfo::before);
          ...
          if (isSgClassDeclaration (declStmt) != NULL)
          {
            ...
            if (declStmt->isForward () == false)
            {
              printf ("Warning about declStmt = %p = %s \n", declStmt,
                  declStmt->sage_class_name ());
              declStmt->get_file_info ()->display (
                  "Warning: declStmt->isForward() == false (should be true)");
            }
      ...
      if ((vardecl_stmt->skipElaborateType ()) && (declStmt != NULL)
          && (isSgTypedefDeclaration (declStmt) == NULL))
      {
      ...
      if (tmp_name.is_null () == false)
      {
        ...
        if (SageInterface::is_Cxx_language () == true)
        {
          ...
          SgName nameQualifier = unp->u_name->generateNameQualifier (decl_item,
              ninfo_for_variable);
        ...
        if (decl_item->get_register_name_code ()
      ...
      if ((tmp_init != NULL) && !ninfo.SkipInitializer ())
      {
        ...
        SgConstructorInitializer* constructor = isSgConstructorInitializer (
            tmp_init);
#if 0
        if (constructor != NULL)
        {
...
#endif
        if ((tmp_init->variant () == ASSIGN_INIT) || (tmp_init->variant ()
            == AGGREGATE_INIT) ||
        // ( (constructor != NULL) && constructor->get_need_name() && constructor->get_is_explicit_cast() ) )
            ...
            // ( false ) )
            ((constructor != NULL) && (constructor->get_need_name ()
                || constructor->get_associated_class_unknown ()
                || ninfo.inConditional ())))
        {
          ...
          // curprint ( string(" = "));
          if (constructor != NULL && isSgForInitStatement (stmt->get_parent ())
              != NULL)
          {
            ...
            if (constructor->get_need_name () == true
                && constructor->get_is_explicit_cast () == true)
            {
  ...
  if (!ninfo.inEnumDecl () && !ninfo.inArgList () && !ninfo.inConditional ()
      && !ninfo.SkipSemiColon ())
  {
    curprint (string (";"));
  }
    ...
    if (!info.inEmbeddedDecl ())
    {
      ...
      if (classdecl_stmt->get_parent () == NULL)
      {
        classdecl_stmt->get_file_info ()->display (
            "In Unparse_ExprStmt::unparseClassDeclStmt(): classdecl_stmt->get_parent() == NULL");
      }
...
Unparse_ExprStmt::unparseEnumDeclStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  else
  {
    ...
    printf (
        "Need logic to handle enums defined in namespaces and which require qualification \n");
    ...
    if (cdefn)
    {
      SgNamedType *ptype = isSgNamedType (
          cdefn->get_declaration ()->get_type ());
  ...
  || enum_stmt->get_embedded ())
  {
    ...
    SgInitializedNamePtrList::iterator p =
        enum_stmt->get_enumerators ().begin ();
...
void
Unparse_ExprStmt::unparseLabelStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  SgStatementPtrList::iterator positionOfLabel = find (statementList.begin (),
      statementList.end (), label_stmt);
  ...
  if (positionOfLabel == statementList.end ())
  {
    printf ("Found label = %p = %s at end of scope! \n", label_stmt,
        label_stmt->get_label ().str ());
    label_stmt->get_startOfConstruct ()->display (
        "positionOfLabel == statementList.end()");
...
Unparse_ExprStmt::unparseTryStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  SgStatementPtrList::iterator i =
      try_stmt->get_catch_statement_seq ().begin ();
...
isOutputAsmOperand (SgAsmOp* asmOp)
{
  ...
  return (asmOp->get_recordRawAsmOperandDescriptions () == true) ? (asmOp->get_isOutputOperand ()
      == true)
...
#define ASM_DEBUGGING 0
  ...
  if (sourceFile->get_skip_unparse_asm_commands () == true)
  {
    ...
    printf (
        "Warning: Sorry, C language ASM statement skipped (parsed and built in AST, but not output by the code generation phase (unparser)) \n");
  ...
  if (asm_stmt->get_useGnuExtendedFormat ())
  {
    ...
    for (SgExpressionPtrList::const_iterator i =
        asm_stmt->get_operands ().begin (); i
        != asm_stmt->get_operands ().end (); ++i)
    {
    ...
    for (SgAsmStmt::AsmRegisterNameList::const_iterator i =
        asm_stmt->get_clobberRegisterList ().begin (); i
        != asm_stmt->get_clobberRegisterList ().end (); ++i)
    {
      if (!first)
        curprint (", ");
      first = false;
...
Unparse_ExprStmt::unparseTypeDefStmt (SgStatement* stmt, SgUnparse_Info& info)
{
  ...
  if (!info.inEmbeddedDecl ())
  {
    ...
    SgClassDefinition *cdefn =
        isSgClassDefinition (typedef_stmt->get_parent ());
    if (cdefn && cdefn->get_declaration ()->get_class_type ()
        == SgClassDeclaration::e_class)
      info.set_CheckAccess ();
    // printDebugInfo("entering unp->u_sage->printSpecifier", true);
  ...
  SgPointerType* pointerToType = isSgPointerType (
      typedef_stmt->get_base_type ());
  ...
  SgMemberFunctionType* pointerToMemberFunctionType = isSgMemberFunctionType (
      typedef_stmt->get_base_type ());
...
// never seen this function called yet
void
Unparse_ExprStmt::unparseTemplateDeclStmt (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ...
  switch (template_stmt->get_template_kind ())
  {
    ...
    case SgTemplateDeclaration::e_template_none:
      ...
      printf (
          "Error: SgTemplateDeclaration::e_template_none found (not sure what to do here) \n");
      ROSE_ASSERT (false);
      break;
...
void
Unparse_ExprStmt::unparseUpcNotifyStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
...
void
Unparse_ExprStmt::unparseUpcWaitStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
...
void
Unparse_ExprStmt::unparseUpcBarrierStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
...
void
Unparse_ExprStmt::unparseUpcFenceStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
...
void
Unparse_ExprStmt::unparseUpcForAllStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
  // printf ("Unparse for loop \n");
...
// OpenMP support 
void
Unparse_ExprStmt::unparseOmpPrefix (SgUnparse_Info& info)
{
  curprint (string ("#pragma omp "));
}

void
Unparse_ExprStmt::unparseOmpForStatement (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ROSE_ASSERT (stmt != NULL);
...
void
Unparse_ExprStmt::unparseOmpBeginDirectiveClauses (SgStatement* stmt,
    SgUnparse_Info& info)
{
  ROSE_ASSERT (stmt != NULL);
  // optional clauses
