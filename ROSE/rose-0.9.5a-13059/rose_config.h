...
#define ROSE_OFP_CLASSPATH /export/tmp.hudson-rose/hudson/workspace/a95-ROSE-weekly-upload/label/amd64-linux/ROSE-build/../src/3rdPartyLibraries/antlr-jars/antlr-3.2.jar:/export/tmp.hudson-rose/hudson/workspace/a95-ROSE-weekly-upload/label/amd64-linux/ROSE-build/../src/3rdPartyLibraries/fortran-parser/OpenFortranParser-0.8.2.jar:.
...
/* Whether to use FadaLib (Fuzzy Array Dataflow Analysis) support or not
   within ROSE */
/* #undef ROSE_USE_FADALIB */
