...
void
FortranCodeGeneration_locatedNode::unparseLanguageSpecificExpression (
...
//      break;
    ...
    {
      printf (
          "FortranCodeGeneration_locatedNode::unparseExpression: Error: No handler for %s (variant: %d)\n",
...
void
FortranCodeGeneration_locatedNode::unparseActualArgumentExpression (
    SgExpression* expr, SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseLabelRefExp (SgExpression* expr,
    SgUnparse_Info& info)
{
  ...
  SgStatement* tmp_statement = SageInterface::getEnclosingStatement (
      labelRefExp);
  ...
  if (isSgIOStatement (tmp_statement) == NULL && isSgReturnStmt (tmp_statement)
      == NULL)
  {
  ...
  else
  {
    if (isSgReturnStmt (tmp_statement) != NULL)
    {
      ...
      SgFunctionDefinition* functionDefinition =
          SageInterface::getEnclosingFunctionDefinition (tmp_statement, /* includingSelf= */
          true);
...
void
FortranCodeGeneration_locatedNode::unparseExprRoot (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseFuncCall (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseUnaryOperator (SgExpression* expr,
    const char* op, SgUnparse_Info& info)
{
  SgUnparse_Info ninfo (info);
...
void
FortranCodeGeneration_locatedNode::unparseBinaryOperator (SgExpression* expr,
    const char* op, SgUnparse_Info& info)
{
  SgUnparse_Info ninfo (info);
  ninfo.set_operator_name (op);
...
void
FortranCodeGeneration_locatedNode::unparseAssnOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparsePointerAssnOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  unparseBinaryOperator (expr, "=>", info);
}
...
void
FortranCodeGeneration_locatedNode::unparseNotOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseAndOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseOrOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
outputLogicalOperator (SgExpression* expr)
{
  ...
  if (binaryOp != NULL)
  {
    ...
    if (isSgTypeBool (lhs_type) != NULL)
    {
      ...
      {
        printf (
            "Error: outputLogicalOperator(). Found a boolean lhs operand paired with a non-boolean rhs operand for SgExpression:%s\n",
...
void
FortranCodeGeneration_locatedNode::unparseEqOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseNeOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  ROSE_ASSERT(expr != NULL);
...
void
FortranCodeGeneration_locatedNode::unparseLtOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseGtOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseLeOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseGeOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseUnaryMinusOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseUnaryAddOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseAddOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseSubtOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseMultOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseDivOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseIntDivOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseExpOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseModOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseBitXOrOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseBitAndOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseBitOrOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseLShiftOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseRShiftOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  // Sage node corresponds to Fortran ishft(x,-) intrinsic
  // FIXME:eraxxon: need special case in unparseBinaryExpr
...
void
FortranCodeGeneration_locatedNode::unparseBitCompOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseConcatenationOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  // Sage node corresponds to Fortran addition operator
  unparseBinaryOperator (expr, "//", info);
...
void
FortranCodeGeneration_locatedNode::unparseArrayOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseRecRef (SgExpression* expr,
    SgUnparse_Info& info)
{
  ...
  curprint ("%");
  SgPntrArrRefExp* arrayRefExp =
      isSgPntrArrRefExp (dotExpr->get_rhs_operand ());
  if (arrayRefExp != NULL)
  {
    unparseExpression (arrayRefExp->get_lhs_operand (), info);
    curprint ("(");
...
void
FortranCodeGeneration_locatedNode::unparseCastOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  ...
  printf (
      "Case operators not defined for Fortran code generation! node = %s \n",
      expr->class_name ().c_str ());
  // ROSE_ASSERT(false);
...
void
FortranCodeGeneration_locatedNode::unparseNewOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  printf (
      "Case operators not defined for Fortran code generation! node = %s \n",
...
void
FortranCodeGeneration_locatedNode::unparseDeleteOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  printf (
      "Case operators not defined for Fortran code generation! node = %s \n",
...
void
FortranCodeGeneration_locatedNode::unparsePointStOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseDerefOp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseAddrOp (SgExpression* expr,
    SgUnparse_Info& info)
{
  // Sage node has no explicit Fortran correspondence
  // FIXME:eraxxon:
...
void
FortranCodeGeneration_locatedNode::unparseTypeRef (SgExpression* expr,
    SgUnparse_Info& info)
{
  // FIXME:eraxxon
...
void
FortranCodeGeneration_locatedNode::unparseSubscriptExpr (SgExpression* expr,
    SgUnparse_Info& info)
{
  ...
  bool defaultValue = ((integerValue != NULL) && (integerValue->get_value ()
      == 1)) ? true : false;
...
void
FortranCodeGeneration_locatedNode::unparseColonShapeExp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseAsteriskShapeExp (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseInitializerList (SgExpression* expr,
    SgUnparse_Info& info)
{
  ROSE_ASSERT(expr);
...
void
FortranCodeGeneration_locatedNode::unparseAggrInit (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseConInit (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseAssnInit (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseIOItemExpr (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseImpliedDo (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseVarRef (SgExpression* expr,
    SgUnparse_Info& info)
{
  ...
  SgVariableDeclaration* vd =
      isSgVariableDeclaration (decl->get_declaration ());
  ...
  if (false /*vd != NULL*/)
  {
    ...
    if (cdef != NULL)
    {
      ...
      SgClassDeclaration* cdecl = isSgClassDeclaration (
...
void
FortranCodeGeneration_locatedNode::unparseFuncRef (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseMFuncRef (SgExpression* expr,
    SgUnparse_Info& info)
{
  printf (
      "Case operators not defined for Fortran code generation! node = %s \n",
...
void
FortranCodeGeneration_locatedNode::unparseClassRef (SgExpression* expr,
    SgUnparse_Info& info)
{
  printf (
      "Case operators not defined for Fortran code generation! node = %s \n",
...
void
FortranCodeGeneration_locatedNode::unparseCudaKernelCall (SgExpression* expr,
    SgUnparse_Info& info)
{
...
//  curprint (">>>");
//
//  unparseExprList(kernel_call->get_args(), info, true);
}

void
FortranCodeGeneration_locatedNode::unparseStringVal (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseBoolVal (SgExpression* expr,
    SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseExprList (SgExpression* expr,
    SgUnparse_Info& info, bool paren)
{
  ROSE_ASSERT(expr);
  SgExprListExp* expr_list = isSgExprListExp (expr);
...
FortranCodeGeneration_locatedNode::isSubroutineCall (SgFunctionCallExp* fcall)
{
  ...
  SgFunctionRefExp* functionRefExp =
      isSgFunctionRefExp (fcall->get_function ());
...
void
FortranCodeGeneration_locatedNode::unparseUnknownArrayOrFunctionReference (
    SgExpression* expr, SgUnparse_Info& info)
{
  ...
  SgExpression* variableReference =
      assumeArrayReference->get_named_reference ();
...
void
FortranCodeGeneration_locatedNode::unparseUserDefinedUnaryOp (
    SgExpression* expr, SgUnparse_Info& info)
{
...
void
FortranCodeGeneration_locatedNode::unparseUserDefinedBinaryOp (
    SgExpression* expr, SgUnparse_Info& info)
{
  SgUserDefinedBinaryOp* userDefinedBinaryOp = isSgUserDefinedBinaryOp (expr);

  unparseBinaryOperator (expr,
      userDefinedBinaryOp->get_operator_name ().str (), info);
}

//FMZ (02/02/2009): Added for unparsing co_expression
void
FortranCodeGeneration_locatedNode::unparseCoArrayExpression (
    SgExpression* expr, SgUnparse_Info& info)
{
